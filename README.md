...
| Crafting | 110 | 76 actions | Gem cutting (7), jewellery (8 rings + 8 amulets + 2 silver slayer rings), Leather Armour (cowhide from Cows; 1× per piece, 3× body, 2× chaps), Hunter Leather (kebbit + kyatt), Dragonhide (5 tiers), Mage Armour (3 tiers — cloth lv20, splitbark lv55, lunar lv65), **Magic Weapons** (14 — 7 wands 1H 3-tick + 7 staffs 2H 4-tick, Logs lv5→Birch wand through Magic staff at lv70; each requires matching Divination energy + logs; top tier magic_wand: 8% bonus hit, magic_staff: 5% bonus hit); batch crafting; all jewelry has sell prices and unique perks |
