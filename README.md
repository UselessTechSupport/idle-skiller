...
| Thieving | 99 | 19 actions | Pickpocket (9 NPCs, catch/stun mechanic) + Locks (6 chests); seeds, gems, bars, and coins from drops; agility gives extra loot chance; 📋 drop table viewer on all NPCs and chests |
